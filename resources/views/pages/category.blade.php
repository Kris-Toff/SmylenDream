    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <ul class="nav nav-pills nav-fill">
                ...
                <a class="nav-pills-size custom-nav-pills bg-light {{ $category == 'native bags' ? 'custom-nav-pills-active text-success' : 'custom-nav-pills-inactive' }}" href="/products/native bags/category">
                    <p class="nav-pills-v-center"><i class="fas fa-shopping-bag fa-2x"></i></p>
                    <p>Native Bags</p>
                </a>
                </li>
                <li class="nav-item">
                <a class="nav-pills-size custom-nav-pills bg-light {{ $category == 'handicrafts' ? 'custom-nav-pills-active text-success' : 'custom-nav-pills-inactive' }}" href="/products/handycrafts/category">
                    <p class="nav-pills-v-center"><i class="fas fa-gavel fa-2x"></i></p>
                    <p>Handicrafts</p>
                </a>
                </li>
                <li class="nav-item">
                <a class="nav-pills-size custom-nav-pills bg-light {{ $category == 'food' ? 'custom-nav-pills-active text-success' : 'custom-nav-pills-inactive' }}" href="/products/food/category">
                    <p class="nav-pills-v-center"><i class="fas fa-utensils fa-2x"></i></p>
                    <p>Food</p>
                </a>
                </li>
                <li class="nav-item">
                <a class="nav-pills-size custom-nav-pills bg-light {{ $category == 'health' ? 'custom-nav-pills-active text-success' : 'custom-nav-pills-inactive' }}" href="/products/health/category">
